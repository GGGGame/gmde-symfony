 ...
 */
final class Version20250718104215 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE vehicle (id INT AUTO_INCREMENT NOT NULL, engine_specs_id INT DEFAULT NULL, fuel_specs_id INT DEFAULT NULL, transmission_specs_id INT DEFAULT NULL, dimension_specs_id INT DEFAULT NULL, performance_specs_id INT DEFAULT NULL, electric_specs_id INT DEFAULT NULL, brand VARCHAR(255) NOT NULL, model VARCHAR(255) NOT NULL, year INT NOT NULL, base_model VARCHAR(255) DEFAULT NULL, vehicle_size_class VARCHAR(255) DEFAULT NULL, atv_type VARCHAR(255) DEFAULT NULL, guzzler VARCHAR(255) DEFAULT NULL, vehicle_save_spend INT DEFAULT NULL, vehicle_id INT DEFAULT NULL, created_on DATE DEFAULT NULL, modified_on DATE DEFAULT NULL, INDEX IDX_1B80E48617469268 (engine_specs_id), INDEX IDX_1B80E486F2AE23BA (fuel_specs_id), INDEX IDX_1B80E486226990F2 (transmission_specs_id), INDEX IDX_1B80E4862465B5E2 (dimension_specs_id), INDEX IDX_1B80E48646A97D17 (performance_specs_id), INDEX IDX_1B80E486F7CA1386 (electric_specs_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
